...
const Content = ({ aboutRef, experienceRef, projectsRef, contentRef }) => {
  return (
    <>
      {/* ABOUT  */}
      <div ref={aboutRef} className='pt-10 lg:pt-20'>
      ...
      {/* EXPERIENCE  */}
      <div ref={experienceRef} className={`pt-10 flex flex-col gap-4`}>
      ...
      {/* PROJECTS  */}
      <div ref={projectsRef} className='pt-10 flex flex-col gap-4'>
      <h2 className='font-bold text-slate-100 uppercase py-8 block lg:hidden'>Projects</h2>
        <Link to={'https://bumble-bai-market.onrender.com/'} target='_blank'>
          <button
            className='flex flex-col-reverse md:flex-row items-start gap-4 hover:bg-gray-700 hover:bg-opacity-50 backdrop-blur-md bg-opacity-25 rounded-md relative p-4 lg:right-4 group text-start'>
